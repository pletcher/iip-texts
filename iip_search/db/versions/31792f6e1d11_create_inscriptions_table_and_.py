...
Revision ID: 31792f6e1d11
Revises: 
Create Date: 2023-07-20 14:53:48.677218
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("edition_id", "bibliographic_entry_id"),
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table("edition_bibliographic_entry")
